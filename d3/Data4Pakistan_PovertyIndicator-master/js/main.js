...
//Read the data
let questions = [
  d3.csv("https://raw.githubusercontent.com/ChihHsiangChien/question_database/master/nature.csv"),
];
...
function updateChart(someData, xAxisLabel, time) {
  ...
  circles
    ...
    .attr("cx", function (d) {
	  ...
	  d["Adult literacy, 25 or more years old (% of population aged 25 or more)"] ||
	  d["Labor force participation rate (% of working age population, 15-64 years old)"] ||
